...
class PhotoListAdapter(val photoListData: List<PhotosModel>, val context: Context): BaseAdapter() {
    override fun getCount(): Int {
        return photoListData.size
    }

    override fun getItem(p0: Int): Any {
        return photoListData[p0]
    }
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        urlText.text= item.url.toString()
        return itemLayout
    }
